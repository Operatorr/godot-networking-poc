...
const HP_BAR_PATH := "res://scripts/ui/hud/hp_bar.gd"
const STAT_BAR_PATH := "res://scripts/ui/hud/stat_bar.gd"
const ABILITY_SLOTS_PATH := "res://scripts/ui/hud/ability_slots.gd"
